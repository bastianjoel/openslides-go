...
var RelationFields = map[string]string{
	...
	"committee/parent_id":                                                    "committee/child_ids",
	"gender/organization_id":                                                 "organization/gender_ids",
	...
	"history_entry/meeting_id":                                               "meeting/relevant_history_entry_ids",
	"history_entry/position_id":                                              "history_position/entry_ids",
	"history_position/user_id":                                               "user/history_position_ids",
	"list_of_speakers/meeting_id":                                            "meeting/list_of_speakers_ids",
	"mediafile/parent_id":                                                    "mediafile/child_ids",
	"mediafile/published_to_meetings_in_organization_id":                     "organization/published_mediafile_ids",
	"meeting/admin_group_id":                                                 "group/admin_group_for_meeting_id",
	"meeting/anonymous_group_id":                                             "group/anonymous_group_for_meeting_id",
	"meeting/assignment_poll_config_id":                                      "meeting_poll_default/used_as_assignment_poll_config_in_meeting_id",
	...
	"meeting/font_bold_id":                                                   "meeting_mediafile/used_as_font_bold_in_meeting_id",
	"meeting/font_bold_italic_id":                                            "meeting_mediafile/used_as_font_bold_italic_in_meeting_id",
	"meeting/font_chyron_speaker_name_id":                                    "meeting_mediafile/used_as_font_chyron_speaker_name_in_meeting_id",
	"meeting/font_italic_id":                                                 "meeting_mediafile/used_as_font_italic_in_meeting_id",
	"meeting/font_monospace_id":                                              "meeting_mediafile/used_as_font_monospace_in_meeting_id",
	"meeting/font_projector_h1_id":                                           "meeting_mediafile/used_as_font_projector_h1_in_meeting_id",
	"meeting/font_projector_h2_id":                                           "meeting_mediafile/used_as_font_projector_h2_in_meeting_id",
	"meeting/font_regular_id":                                                "meeting_mediafile/used_as_font_regular_in_meeting_id",
	...
	"meeting/logo_pdf_ballot_paper_id":                                       "meeting_mediafile/used_as_logo_pdf_ballot_paper_in_meeting_id",
	"meeting/logo_pdf_footer_l_id":                                           "meeting_mediafile/used_as_logo_pdf_footer_l_in_meeting_id",
	"meeting/logo_pdf_footer_r_id":                                           "meeting_mediafile/used_as_logo_pdf_footer_r_in_meeting_id",
	"meeting/logo_pdf_header_l_id":                                           "meeting_mediafile/used_as_logo_pdf_header_l_in_meeting_id",
	"meeting/logo_pdf_header_r_id":                                           "meeting_mediafile/used_as_logo_pdf_header_r_in_meeting_id",
	"meeting/logo_projector_header_id":                                       "meeting_mediafile/used_as_logo_projector_header_in_meeting_id",
	"meeting/logo_projector_main_id":                                         "meeting_mediafile/used_as_logo_projector_main_in_meeting_id",
	"meeting/logo_web_header_id":                                             "meeting_mediafile/used_as_logo_web_header_in_meeting_id",
	"meeting/motion_poll_config_id":                                          "meeting_poll_default/used_as_motion_poll_config_in_meeting_id",
	...
	"meeting/topic_poll_config_id":                                           "meeting_poll_default/used_as_topic_poll_config_in_meeting_id",
	"meeting_mediafile/list_of_speakers_id":                                  "list_of_speakers/content_object_id",
	"meeting_mediafile/mediafile_id":                                         "mediafile/meeting_mediafile_ids",
	"meeting_mediafile/meeting_id":                                           "meeting/meeting_mediafile_ids",
	"meeting_mediafile/used_as_font_bold_in_meeting_id":                      "meeting/font_bold_id",
	"meeting_mediafile/used_as_font_bold_italic_in_meeting_id":               "meeting/font_bold_italic_id",
	"meeting_mediafile/used_as_font_chyron_speaker_name_in_meeting_id":       "meeting/font_chyron_speaker_name_id",
	"meeting_mediafile/used_as_font_italic_in_meeting_id":                    "meeting/font_italic_id",
	"meeting_mediafile/used_as_font_monospace_in_meeting_id":                 "meeting/font_monospace_id",
	"meeting_mediafile/used_as_font_projector_h1_in_meeting_id":              "meeting/font_projector_h1_id",
	"meeting_mediafile/used_as_font_projector_h2_in_meeting_id":              "meeting/font_projector_h2_id",
	"meeting_mediafile/used_as_font_regular_in_meeting_id":                   "meeting/font_regular_id",
	"meeting_mediafile/used_as_logo_pdf_ballot_paper_in_meeting_id":          "meeting/logo_pdf_ballot_paper_id",
	"meeting_mediafile/used_as_logo_pdf_footer_l_in_meeting_id":              "meeting/logo_pdf_footer_l_id",
	"meeting_mediafile/used_as_logo_pdf_footer_r_in_meeting_id":              "meeting/logo_pdf_footer_r_id",
	"meeting_mediafile/used_as_logo_pdf_header_l_in_meeting_id":              "meeting/logo_pdf_header_l_id",
	"meeting_mediafile/used_as_logo_pdf_header_r_in_meeting_id":              "meeting/logo_pdf_header_r_id",
	"meeting_mediafile/used_as_logo_projector_header_in_meeting_id":          "meeting/logo_projector_header_id",
	"meeting_mediafile/used_as_logo_projector_main_in_meeting_id":            "meeting/logo_projector_main_id",
	"meeting_mediafile/used_as_logo_web_header_in_meeting_id":                "meeting/logo_web_header_id",
	"meeting_poll_default/meeting_id":                                        "meeting/poll_default_ids",
	"meeting_poll_default/used_as_assignment_poll_config_in_meeting_id":      "meeting/assignment_poll_config_id",
	"meeting_poll_default/used_as_motion_poll_config_in_meeting_id":          "meeting/motion_poll_config_id",
	...
	"motion_supporter/meeting_id":                                            "meeting/motion_supporter_ids",
	"motion_supporter/meeting_user_id":                                       "meeting_user/motion_supporter_ids",
	"motion_supporter/motion_id":                                             "motion/supporter_ids",
	...
	"poll_ballot/poll_id":                                                    "poll/ballot_ids",
	"poll_ballot/represented_meeting_user_id":                                "meeting_user/represented_ballot_ids",
	...
	"projector/used_as_default_projector_for_current_los_in_meeting_id":      "meeting/default_projector_current_los_ids",
	...
	"projector/used_as_default_projector_for_topic_poll_in_meeting_id":       "meeting/default_projector_topic_poll_ids",
...
var RelationListFields = map[string]string{
	...
	"assignment/history_entry_ids":                             "history_entry/model_id",
	...
	"committee/all_child_ids":                                  "committee/all_parent_ids",
	"committee/all_parent_ids":                                 "committee/all_child_ids",
	"committee/child_ids":                                      "committee/parent_id",
	...
	"committee/native_user_ids":                                "user/home_committee_id",
	...
	"gender/user_ids":                                          "user/gender_id",
	"group/meeting_mediafile_access_group_ids":                 "meeting_mediafile/access_group_ids",
	"group/meeting_mediafile_inherited_access_group_ids":       "meeting_mediafile/inherited_access_group_ids",
	...
	"group/used_in_meeting_poll_default_ids":                   "meeting_poll_default/group_ids",
	...
	"history_position/entry_ids":                               "history_entry/position_id",
	...
	"meeting/default_projector_current_los_ids":                "projector/used_as_default_projector_for_current_los_in_meeting_id",
	...
	"meeting/default_projector_topic_poll_ids":                 "projector/used_as_default_projector_for_topic_poll_in_meeting_id",
	...
	"meeting/meeting_mediafile_ids":                            "meeting_mediafile/meeting_id",
	...
	"meeting/motion_supporter_ids":                             "motion_supporter/meeting_id",
	...
	"meeting/poll_default_ids":                                 "meeting_poll_default/meeting_id",
	...
	"meeting/relevant_history_entry_ids":                       "history_entry/meeting_id",
	...
	"meeting_poll_default/group_ids":                           "group/used_in_meeting_poll_default_ids",
	"meeting_user/acting_ballot_ids":                           "poll_ballot/acting_meeting_user_id",
	...
	"meeting_user/poll_voted_ids":                              "poll/voted_ids",
	"meeting_user/represented_ballot_ids":                      "poll_ballot/represented_meeting_user_id",
	...
	"motion/attachment_meeting_mediafile_ids":                  "meeting_mediafile/attachment_ids",
	...
	"motion/history_entry_ids":                                 "history_entry/model_id",
	...
	"motion/supporter_ids":                                     "motion_supporter/motion_id",
	...
	"organization/gender_ids":                                  "gender/organization_id",
	"organization/mediafile_ids":                               "mediafile/owner_id",
	"organization/organization_tag_ids":                        "organization_tag/organization_id",
	"organization/published_mediafile_ids":                     "mediafile/published_to_meetings_in_organization_id",
	...
	"poll/ballot_ids":                                          "poll_ballot/poll_id",
	"poll/entitled_group_ids":                                  "group/poll_ids",
	"poll/history_entry_ids":                                   "history_entry/model_id",
	"poll/option_ids":                                          "poll_option/poll_id",
...
var GenericRelationFields = map[string]map[string]string{
	...
	"history_entry/model_id":             {"assignment": "history_entry_ids", "meeting_user": "history_entry_ids", "motion": "history_entry_ids", "poll": "history_entry_ids", "user": "history_entry_ids"},
...
var GenericRelationListFields = map[string]map[string]string{
	"meeting_mediafile/attachment_ids":              {"assignment": "attachment_meeting_mediafile_ids", "motion": "attachment_meeting_mediafile_ids", "topic": "attachment_meeting_mediafile_ids"},
...
var RestrictionModes = map[string]string{
	...
	// committee
	"committee/all_child_ids":                          "A",
	"committee/all_parent_ids":                         "A",
	"committee/child_ids":                              "A",
	...
	"group/id":                                           "A",
	"group/meeting_id":                                   "A",
	"group/meeting_mediafile_access_group_ids":           "A",
	"group/meeting_mediafile_inherited_access_group_ids": "A",
	...
	"group/used_in_meeting_poll_default_ids":             "A",
	"group/weight":                                       "A",
	...
	"history_position/id":               "A",
	"history_position/original_user_id": "A",
	"history_position/timestamp":        "A",
	"history_position/user_id":          "A",
	...
	"mediafile/meeting_mediafile_ids":                    "A",
	...
	// meeting
	"meeting/admin_group_id":                                        "A",
	"meeting/committee_id":                                          "A",
	...
	"meeting/assignment_poll_config_id":                             "B",
	...
	"meeting/default_projector_current_los_ids":                     "B",
	...
	"meeting/default_projector_topic_poll_ids":                      "B",
	...
	"meeting/meeting_mediafile_ids":                                 "B",
	...
	"meeting/motion_poll_config_id":                                 "B",
	"meeting/motion_state_ids":                                      "B",
	"meeting/motion_submitter_ids":                                  "B",
	"meeting/motion_supporter_ids":                                  "B",
	...
	"meeting/motions_enable_origin_motion_display":                  "B",
	"meeting/motions_enable_reason_on_projector":                    "B",
	"meeting/motions_enable_recommendation_on_projector":            "B",
	"meeting/motions_enable_restricted_editor_for_manager":          "B",
	"meeting/motions_enable_restricted_editor_for_non_manager":      "B",
	...
	"meeting/motions_origin_motion_toggle_default":                  "B",
	...
	"meeting/topic_ids":                                             "B",
	"meeting/topic_poll_config_id":                                  "B",
	"meeting/topic_poll_default_method":                             "B",
	...
	"meeting/jitsi_domain":                                          "E",
	"meeting/jitsi_room_name":                                       "E",
	"meeting/jitsi_room_password":                                   "E",
	"meeting/enable_anonymous":                                      "F",
	"meeting/end_time":                                              "F",
	"meeting/external_id":                                           "F",
	"meeting/is_active_in_organization_id":                          "F",
	"meeting/is_archived_in_organization_id":                        "F",
	"meeting/language":                                              "F",
	"meeting/location":                                              "F",
	...
	"meeting_mediafile/attachment_ids":                                 "A",
	"meeting_mediafile/id":                                             "A",
	"meeting_mediafile/inherited_access_group_ids":                     "A",
	"meeting_mediafile/is_public":                                      "A",
	"meeting_mediafile/list_of_speakers_id":                            "A",
	"meeting_mediafile/mediafile_id":                                   "A",
	"meeting_mediafile/meeting_id":                                     "A",
	"meeting_mediafile/projection_ids":                                 "A",
	"meeting_mediafile/used_as_font_bold_in_meeting_id":                "A",
	"meeting_mediafile/used_as_font_bold_italic_in_meeting_id":         "A",
	"meeting_mediafile/used_as_font_chyron_speaker_name_in_meeting_id": "A",
	"meeting_mediafile/used_as_font_italic_in_meeting_id":              "A",
	"meeting_mediafile/used_as_font_monospace_in_meeting_id":           "A",
	"meeting_mediafile/used_as_font_projector_h1_in_meeting_id":        "A",
	"meeting_mediafile/used_as_font_projector_h2_in_meeting_id":        "A",
	"meeting_mediafile/used_as_font_regular_in_meeting_id":             "A",
	"meeting_mediafile/used_as_logo_pdf_ballot_paper_in_meeting_id":    "A",
	"meeting_mediafile/used_as_logo_pdf_footer_l_in_meeting_id":        "A",
	"meeting_mediafile/used_as_logo_pdf_footer_r_in_meeting_id":        "A",
	"meeting_mediafile/used_as_logo_pdf_header_l_in_meeting_id":        "A",
	"meeting_mediafile/used_as_logo_pdf_header_r_in_meeting_id":        "A",
	"meeting_mediafile/used_as_logo_projector_header_in_meeting_id":    "A",
	"meeting_mediafile/used_as_logo_projector_main_in_meeting_id":      "A",
	"meeting_mediafile/used_as_logo_web_header_in_meeting_id":          "A",

	// meeting_poll_default
	"meeting_poll_default/allow_abstain":                                "A",
	"meeting_poll_default/allow_nota":                                   "A",
	"meeting_poll_default/display_chart":                                "A",
	"meeting_poll_default/group_ids":                                    "A",
	"meeting_poll_default/id":                                           "A",
	"meeting_poll_default/meeting_id":                                   "A",
	"meeting_poll_default/onehundred_percent_base":                      "A",
	"meeting_poll_default/sort_result_by_votes":                         "A",
	"meeting_poll_default/strike_out":                                   "A",
	"meeting_poll_default/used_as_assignment_poll_config_in_meeting_id": "A",
	"meeting_poll_default/used_as_motion_poll_config_in_meeting_id":     "A",
	"meeting_poll_default/used_as_topic_poll_config_in_meeting_id":      "A",
	"meeting_poll_default/visibility":                                   "A",
	...
	"meeting_user/meeting_id":                       "C",
	"meeting_user/user_id":                          "C",
	...
	"motion/attachment_meeting_mediafile_ids":                  "C",
	"motion/block_id":                                          "C",
	...
	"motion_state/state_button_label":                  "A",
	...
	// motion_supporter
	"motion_supporter/id":              "A",
	"motion_supporter/meeting_id":      "A",
	"motion_supporter/meeting_user_id": "A",
	"motion_supporter/motion_id":       "A",
	...
	"organization/disable_forward_with_attachments":             "A",
	"organization/enable_anonymous":                             "A",
	"organization/enable_chat":                                  "A",
	...
	"organization/restrict_editing_same_level_committee_admins": "A",
	...
	"organization/limit_of_meetings":                            "C",
	"organization/limit_of_users":                               "C",
	"organization/user_ids":                                     "C",
	"organization/saml_attr_mapping":                            "D",
	"organization/saml_metadata_idp":                            "D",
	"organization/saml_metadata_sp":                             "D",
	"organization/saml_private_key":                             "D",
	"organization/published_mediafile_ids":                      "E",
	...
	"poll_ballot/acting_meeting_user_id":      "C",
	"poll_ballot/represented_meeting_user_id": "C",
	...
	"projector/used_as_default_projector_for_current_los_in_meeting_id":      "A",
	...
	"projector/used_as_default_projector_for_topic_poll_in_meeting_id":       "A",
	...
	"user/first_name":                    "A",
	"user/gender_id":                     "A",
	"user/history_entry_ids":             "A",
	"user/history_position_ids":          "A",
	"user/id":                            "A",
	"user/is_demo_user":                  "A",
